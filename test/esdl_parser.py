...
RECEIVES_SERVICE_NAMES_LIST = ["emsservice"]
...
def get_connected_input_esdl_objects(esdl_id: EsdlId, calculation_services: typing.List[dict], energy_system: EnergySystem) -> dict[str, typing.List[EsdlId]]:
